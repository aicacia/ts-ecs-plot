...
var Arc = /** @class */ (function (_super) {
    ...
    function Arc() {
        ...
        _this.start = gl_matrix_1.vec2.fromValues(1, 0);
        _this.end = gl_matrix_1.vec2.fromValues(1, 0);
    ...
    Arc.prototype.setLineWidth = function (lineWidth) {
        this.lineWidth = lineWidth;
        return this;
    };
    Arc.prototype.getLineWidth = function () {
